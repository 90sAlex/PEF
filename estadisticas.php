...
echo "<tr><th>Id</th><th>Codigo</th><th>Nombre</th><th>Units</th><th>Fecha</th><th>Total $</th></tr>";
...
try {
    ...
    $stmt = $conn->prepare("SELECT id, product_code, product_name, units, date, total FROM orders"); 
    $stmt->execute();
